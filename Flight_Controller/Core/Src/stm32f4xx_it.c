...
uint8_t _rx_buf[52];
uint8_t _rx_cplt_flag = 0;
uint8_t tim10_20ms_flag = 0;
uint8_t tim10_1ms_flag = 0;
uint8_t tim10_100ms_flag = 0;
uint8_t tim10_1000ms_flag = 0;
/* USER CODE END PV */
...
void TIM1_UP_TIM10_IRQHandler(void)
{
  /* USER CODE BEGIN TIM1_UP_TIM10_IRQn 0 */
	...
	if(LL_TIM_IsActiveFlag_UPDATE(TIM10))
	{
		...
		tim10_1000ms_count++;
		if(tim10_1000ms_count == 1000)
		{
			tim10_1000ms_count = 0;
			tim10_1000ms_flag = 1;
		}
	}
